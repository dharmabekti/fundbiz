...
<section id="contact">
            ...
            <div class="container">
                ...
                <form action="{{ route('pages.post') }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
    ...
    <label for="exampleInputEmail">Dana yang Dibutuhkan</label>
                            <input type="text" class="form-control" name="dana" id="dana" placeholder=" Masukkan Dana Yang Dibutuhkan Produk">
                        </div> 
                        <div class="form-group">
                            <label for="exampleInputEmail">Waktu Peminjaman (bulan)</label>
                            <input type="number" min="1" max="24" value="1" class="form-control" name="waktu_pinjam" id="waktu_pinjam" placeholder=" Masukkan Waktu Peminjaman">
                        </div>   
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea  class="form-control" id="description" name="deskripsi_produk" placeholder="Masukkan Deskripsi Produk"></textarea>
                        </div>
                        <div>
